...
declare module CodeMirror {
    ...
    interface Editor {
        ...
        where determines to which element this class should be applied, can be one of "text" (the text element, which lies in front of the selection),
        ...
        You can pass null for either of them to indicate that dimension should not be changed. */
